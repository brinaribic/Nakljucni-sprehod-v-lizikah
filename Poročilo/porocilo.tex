...
\begin{figure}
%    \includegraphics[scale=0.8]{pokritje_sonce_n.png}
\end{figure}
...
\begin{figure}
%    \includegraphics[scale=0.8]{pokritje_sonce_m.png}
\end{figure}
...
\begin{figure}[!tbp]
    ...
    \begin{minipage}[b]{0.6\textwidth}
      \includegraphics[width=\textwidth]{doseg_sonce_n.png}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.6\textwidth}
      \includegraphics[width=\textwidth]{doseg_sonce_m.png}
    \end{minipage}
  \end{figure}
...
\begin{figure}[!tbp]
    \centering
    \begin{minipage}[b]{0.6\textwidth}
      \includegraphics[width=\textwidth]{doseg_sonce1_n.png}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.6\textwidth}
      \includegraphics[width=\textwidth]{doseg_sonce1_m.png}
    \end{minipage}
  \end{figure}
  ...
  \begin{figure}[!tbp]
    \centering
    \begin{minipage}[b]{0.6\textwidth}
      \includegraphics[width=\textwidth]{vrnitev_sonce_n.png}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.6\textwidth}
      \includegraphics[width=\textwidth]{vrnitev_sonce_m.png}
    \end{minipage}
  \end{figure}
